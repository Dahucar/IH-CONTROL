<div class="ayuda container">
    <?php if (isset($_SESSION['IDENTIDAD']) && $_SESSION['IDENTIDAD']->rol == "ADMINISTRADOR"): ?>
        ...
        <?php if (isset($_SESSION['DETALLECOMPADM']['ERR'])): ?>
            <div class="alert alert-danger" role="alert">
                <strong><?= $_SESSION['DETALLECOMPADM']['ERR'] ?></strong> 
            </div>
        <?php else: ?>

            <h1>Módulo administrador: detalle de compra</h1>
        ...
        <?php endif; ?>
            <?php Utils::borrarSessionNombre('DETALLECOMPADM', 'ERR') ?>
    <?php else: ?>
        <div class="alert alert-danger" role="alert">
